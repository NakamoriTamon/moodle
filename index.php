...
<main>
    ...
    <section id="mv" class="mv-slider nosp">
        <div class="swiper-wrapper mv_img">
            ...
            <div class="swiper-slide">
                <a class="mv_slider_a" href="/custom/app/Views/tekijuku/index.php">
                    <img src="/custom/public/assets/img/home/mv-tekijuku-pc.png" alt="画像2">
                </a>
            </div>
            <?php foreach ($best_events as $best_event): ?>
                <?php if (!empty($best_event['best_event_img'])): ?>
                    <div class="swiper-slide">
                        <a class="mv_slider_a" href="/custom/app/Views/event/detail.php?id=<?= htmlspecialchars($best_event['id']) ?>">
    ...
    <section id="mv" class="mv-slider nopc">
        <div class="swiper-wrapper mv_img">
            ...
            <div class="swiper-slide">
                <a href="/custom/app/Views/tekijuku/index.php">
                    <img src="/custom/public/assets/img/home/mv-tekijuku-sp.png" alt="画像2">
                </a>
            </div>
            <?php foreach ($best_events as $best_event): ?>
