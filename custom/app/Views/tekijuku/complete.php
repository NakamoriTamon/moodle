...
// 表示内容
$title = $payment_type == 2 ? "申し込み完了" : "仮申し込み完了";
$message_title = $payment_type == 2 ? "申し込みが完了いたしました。" : "仮申し込みが完了いたしました。";
$en_title = $payment_type == 2 ? "REGISTRATION COMPLETED" : "PRE-REGISTRATION COMPLETED";
$message = $payment_type == 2 ? "お申し込みが完了いたしました。" : "お支払い期限内にお手続きをお願いいたします。";
    ...
    <div class="inner_l">
        <section id="form" class="complete">
            ...
            <div class="whitebox form_cont">
                ...
                <p class="sent">
                    この度は、適塾記念会にお申し込みいただき、誠にありがとうございます。<br class="sp-none" />
