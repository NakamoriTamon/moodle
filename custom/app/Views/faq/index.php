...
?>
<link rel="stylesheet" type="text/css" href="/custom/public/css/faq.css" />
    <main id="subpage">
        ...
        <div class="inner_l">
            <section id="faq">
                ...
                <ul class="list">
                    ...
                    <li>
                    <p class="l_quest">
                        家族／友達同士で一つのユーザーIDを共有しようと思いますが、構いませんか。
                    </p>
                    <p class="l_answer">テキストテキストテキストテキストテキストテキスト</p>
                    </li>
                </ul>
                ...
                <ul class="list">
                    <li>
                    <p class="l_quest">
                        申し込んでいたイ講座に急用で行けなくなったのですが、返金はしてもらえますか。
                    </p>
                    <p class="l_answer">テキストテキストテキストテキストテキストテキスト</p>
                    </li>
                    <li>
                    <p class="l_quest">
                        スマートフォンやパソコンの操作が得意ではない高齢者です。申し込みが難しいのですが、電話かFAXで申し込んでよろしいですか。
                    </p>
                    <p class="l_answer">テキストテキストテキストテキストテキストテキスト</p>
                    </li>
                    <li>
