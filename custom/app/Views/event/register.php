                ...
                <li class="event_item">
                    ...
                    <div class="event_info">
                        ...
                        <div class="event_btns">
                            ...
                            <a href="../survey/index.php?event_id=48" class="btn_answer">アンケートに回答する</a>
                        </div>
                ...
                <li class="event_item">
                    ...
                    <div class="event_info">
                        ...
                        <div class="event_btns">
                            <a href="" class="btn_pdf">PDF資料</a>
                            <a href="movie.php" class="btn_movie">イベント動画</a>
                            <a href="../survey/index.php?event_id=46" class="btn_answer">アンケートに回答する</a>
                        </div>
                        <p class="event_term">閲覧期間<span>～2000年00月00日まで</span></p>
                    </div>
                </li>
...
<div id="modal" class="modal_pdf">
    ...
    <div class="modal_cont inner_m">
        ...
        <ul class="pdf_list">
            <li>
                <p class="name">PDF1</p>
                <a href="" class="btn btn_navy pdf">PDF資料</a>
            </li>
            <li>
                <p class="name">PDF1</p>
                <a href="" class="btn btn_navy pdf">PDF資料</a>
