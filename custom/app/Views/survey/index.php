                    ...
                    <ul class="list">
                        ...
                        <li>
                            ...
                            <div class="list_field f_radio">
                                ...
                                <label><input type="radio" id="" name="qust05" />満足</label><label><input type="radio" id="" name="qust05" />ふつう</label><label><input type="radio" id="" name="qust05" />不満</label><label><input type="radio" id="" name="qust05" />非常に不満</label>
                            </div>
                        </li>
                        <li>
                            <h4 class="sub_ttl">
                            ...
                            <div class="list_field f_radio">
                                ...
                                <label><input type="radio" id="" name="qust06" />理解できた</label><label><input type="radio" id="" name="qust06" />ふつう</label><label><input type="radio" id="" name="qust06" />理解できなかった</label><label><input type="radio" id="" name="qust06" />全く理解できなかった</label>
                            </div>
                        </li>
                        <li>
                            <h4 class="sub_ttl">
                        ...
                        <li>
                            ...
                            <div class="list_field f_radio">
                                ...
                                <label><input
                                        type="radio"
                                        id=""
                                        name="qust13" />学生（高校生、大学生、大学院生等）</label>
