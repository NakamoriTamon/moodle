...
if (isset($_GET['page'])) {
    ...
    $currentPage = $currentPage_num_check ? (int)$_GET['page'] : 1;
}
...
$url_violation = true;
// GETパラメータにpageが存在するが、そのpageが数値以外の場合
if (isset($_GET['page']) && !$currentPage_num_check) {
    $url_violation = false;
}
...
if ($action === 'index') {
    include '/var/www/html/moodle/custom/admin/app/Views/event/preview.php';
}
