...
require_once('/var/www/html/moodle/custom/admin/app/Controllers/master/tutor/tutor_controller.php');

$tutor_controller = new TutorController();
$tutors = $tutor_controller->index();
?>
                            ...
                            <div class="modal fade" id="confirmDeleteModal" tabindex="-1">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <form id="deleteForm" action="/custom/admin/app/Controllers/master/tutor/tutor_delete_controller.php" method="POST">
