...
require_once('/var/www/html/moodle/custom/admin/app/Controllers/event/event_preview_controller.php');
                                    ...
                                    <ul class="event_status">
                                        ...
                                        <?php if ($row['capacity_flg']): ?>
                                            <?php foreach (DEADLINE_LIST as $key => $status): ?>
                                                <?php if ($key != DEADLINE_END && $key == $row['deadline_status_max']): ?>
                                                    <li class="active"><?= DEADLINE_LIST[$row['deadline_status_max']] ?></li>
                                                <?php elseif ($key == DEADLINE_END && $key == $row['deadline_status_max']): ?>
